...
: "${CMS_HSTS_ENABLED:=false}"
: "${CMS_HSTS_MAX_AGE:=15552000}"
...
CMS_HSTS_ENABLED=$CMS_HSTS_ENABLED
...
export CMS_ADDR CMS_SITE_NAME CMS_ADMIN_USER CMS_ADMIN_PASS CMS_ADMIN_RATE_LIMIT CMS_DATA_DIR CMS_DB CMS_UPLOAD_DIR CMS_WEB_ROOT CMS_CSP_MODE CMS_HSTS_ENABLED CMS_HSTS_MAX_AGE
